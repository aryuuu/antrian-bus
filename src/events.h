...
void unload_bus(int stop_location)
{
    if (stop_location == CAR_RENTAL)
    {
        ...
        event_schedule(sim_time + unload_time + MAXIMUM_WAITING_TIME, EVENT_BUS_GO_TO_TERMINAL_1);
    }
    else if (stop_location == TERMINAL_1)
    {
        ...
        event_schedule(sim_time + unload_time + MAXIMUM_WAITING_TIME, EVENT_BUS_GO_TO_TERMINAL_2);
    }
    else if (stop_location == TERMINAL_2)
    {
        ...
        event_schedule(sim_time + unload_time + MAXIMUM_WAITING_TIME, EVENT_BUS_GO_TO_CAR_RENTAL);
    }
}
...
void load_bus(int from_location)
{
    if (from_location == CAR_RENTAL)
    {
        ...
        event_cancel(EVENT_BUS_GO_TO_TERMINAL_1);
        event_schedule(sim_time + load_time + MAXIMUM_WAITING_TIME, EVENT_BUS_GO_TO_TERMINAL_1);
    }
    else if (from_location == TERMINAL_1)
    {
        ...
        event_cancel(EVENT_BUS_GO_TO_TERMINAL_2);
        event_schedule(sim_time + load_time + MAXIMUM_WAITING_TIME, EVENT_BUS_GO_TO_TERMINAL_2);
    }
    else if (from_location == TERMINAL_2)
    {
        ...
        event_cancel(EVENT_BUS_GO_TO_CAR_RENTAL);
        event_schedule(sim_time + load_time + MAXIMUM_WAITING_TIME, EVENT_BUS_GO_TO_CAR_RENTAL);
    }
}
